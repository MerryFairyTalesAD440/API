...
namespace Functions
{
    public static class PutAudio
    {
        [FunctionName("PutAudio")]
        [Consumes("application/json")]
        [Produces("application/json")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous,
        "put", Route = "books/{bookId}/pages/{pageId}/languages/{languageCode}/audio")]
        HttpRequest req, string bookid, string pageid, string languagecode, ILogger log, ExecutionContext context)
        {
            log.LogInformation("Http function to put audio");
            ...
            //storage variable for new audio url
